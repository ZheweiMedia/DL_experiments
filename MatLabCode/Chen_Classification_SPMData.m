...
for i_increase = 1:f_n
    for i_decrease = 1:f_n
        ...
        for j = 1:repeatNO
            ...
            w_M_copy1 = W_matrix;
            increase_feature = featureNO(i_increase);
            increase_index = [];
            for i = 1:increase_feature*2
            ...
            w_M_copy2 = W_matrix;
            decrease_feature = featureNO(i_decrease);
            decrease_index = [];
            for i = 1:decrease_feature*2
            ...
            increase_set = [];
            for i  = 1:2:increase_feature*2
                increase_set = [increase_set; increase_index(i,:)];
            end

            decrease_set = [];
            for i  = 1:2:decrease_feature*2
            ...
            accurate = sum((label_test == test_pred))/length(label_test);
            accurateList = [accurateList accurate];
        end
        accurrate_matrix(i_increase, i_decrease) = sum(accurateList)/repeatNO;
    end
end