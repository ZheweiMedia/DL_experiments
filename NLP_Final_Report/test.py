...
Read data in a data structure.
										   ...
										   --->end_time
										   --->objectives
The structure is  organization---> project
										   --->papers       --->description
...
def cleanData():
	...
	wholeData = list()
	with open('project.csv','rb') as csvfile:
	...
	wholeData = None
	wholeData = list()
	with open('publication.csv', 'rb') as csvfile:
	    reader = csv.DictReader(csvfile)
	    for row in reader:
	        wholeData.append(row)
	...
	wholeData = None
	wholeData = list()
	with open('contractor.csv','rb') as csvfile:
	    reader = csv.DictReader(csvfile)
	    for row in reader:
	        wholeData.append(row)
	...
	with gzip.open('valid_projects.pickle.gz', 'wb') as f:
